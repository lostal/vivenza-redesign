...
export default function Footer() {
  ...
  // Usar fecha estática para evitar hydration mismatch
      ...
      <div className="container py-10 sm:py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div>
              <Link href={EXTERNAL_URLS.GRUPO_SIETE} target="_blank" rel="noopener noreferrer">
                <Image
        ...
        <div className="mt-8 border-t border-border/40 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} {SITE_CONFIG.NAME}. {t('copyright')}
          </p>
        </div>
      </div>
    </footer>
